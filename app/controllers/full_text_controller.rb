...
class FullTextController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    # By default, Blacklight 8 will use 'query', but our solr config is currently configured for 'select'.
    # If we change our solrconfig.xml file, then we should change the value here.
